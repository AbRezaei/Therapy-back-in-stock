 ...
 * @since     1.0.0
 *
 * @property  BackInStocksService $backInStocks
 */
class TherapyBackInStock extends Plugin
{
    // Static Properties
    // =========================================================================
     ...
     * TherapyBackInStock::$plugin
     *
     * @var TherapyBackInStock
     */
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['siteActionTrigger1'] = 'therapy-back-in-stock/back-in-stocks';
            }
        );
